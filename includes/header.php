    ...
    <header id="site-header" class="sticky top-0 z-50 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70 transition-shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex space-x-2">
                    <?php
                        $links = [
                            ['href' => 'index.php', 'icon' => 'home', 'label' => 'Home'],
        ...
        <div id="mobile-menu" class="md:hidden hidden border-t border-gray-200 bg-white/90 backdrop-blur">
            <div class="px-4 py-3 space-y-1">
                <a href="index.php" class="block px-3 py-2 rounded-md text-base <?php echo $current_page === 'index.php' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100 hover:text-blue-700'; ?>">
                    <span class="material-icons align-middle mr-2 text-gray-500">home</span>Home
                </a>
                <a href="login.php" class="block px-3 py-2 rounded-md text-base <?php echo $current_page === 'login.php' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100 hover:text-blue-700'; ?>">
                    <span class="material-icons align-middle mr-2 text-gray-500">login</span>Login
                </a>
                <a href="register.php" class="block px-3 py-2 rounded-md text-base <?php echo $current_page === 'register.php' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100 hover:text-blue-700'; ?>">
                    <span class="material-icons align-middle mr-2 text-gray-500">person_add</span>Register
                </a>
            </div>
        </div>
    </header>
